...
public class Title extends JFrame {
	...
	JButton SearchByYear, SearchByRating, searchByGenre, SearchByCoActor, SearchByDirector, SearchByActor,
			SearchByTitle;
	...
	Title() {
		...
		JLabel l1 = new JLabel("Search By Movie Title");
		l1.setFont(new Font(l1.getName(), Font.BOLD, 55));
		top.add(l1);

		Handler h = new Handler();

		movie = new JTextField(30);
		center.add(show);
		...
		add(movie).setBounds(450, 110, 400, 35);
	...
	class Handler implements ActionListener {
		...
		public void actionPerformed(ActionEvent a) {
			...
			if (a.getSource() == SearchByYear) {
				...
				FirstPage.m.searchByMovieTitle(movie.getText());
				movie.setText("");
