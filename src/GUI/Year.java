...
public class Year extends JFrame {
    ...
    int i = 1916;
    int j =0;
    final static String [] year = new String[101];
	  JTextArea textArea;
...
//	    right.add();
	    ...
	    add(new JScrollPane(list)).setBounds(490, 110, 400, 75);
	...
	//    add(new JScrollPane(textArea)).setBounds(450, 175, 0, 0);
		...
		list.addListSelectionListener(new ListSelectionListener()
		{
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				if(count <1)
				add(new JScrollPane(textArea)).setBounds(490, 210, 400, 282);
				
				int  a = list.getSelectedIndex();
			    String y = year[a];
		        String out = "";
			   out += FirstPage.m.SearchByYear(y);
