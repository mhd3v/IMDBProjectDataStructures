...
public class CoActor extends JFrame {
	
	
	private static final long serialVersionUID = 3588435293291517919L;
	...
	CoActor() {
		...
		JLabel l1 = new JLabel("Search CoActors Of Actor");
	    ...
	    add(co).setBounds(450, 110, 400, 35);
	...
	class Handler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent a) {
			...
			else if(a.getSource() == search)
			{
				...
				String out = "";
				out =  FirstPage.m.searchCoActors(co.getText());
