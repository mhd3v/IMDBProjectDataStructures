...
public class Director  extends JFrame {
	...
	JPanel top, left, bottom, right, center , mix , mix2;
    JButton back;
    ...
    Director() {
		...
		mix = new JPanel(new FlowLayout());
		mix2 = new JPanel(new FlowLayout());
	...
	class Handler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent a) {
			...
			{	if(count < 1)
			    ...
			    output = FirstPage.m.searchByDirector(dir.getText());
