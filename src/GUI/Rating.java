...
public class Rating extends JFrame {
	...
	JButton SearchByYear, SearchByRating, SearchByCoActor, searchByGenre, SearchByDirector, SearchByActor,
			SearchByTitle;
	...
	Rating() {
		...
		JLabel l1 = new JLabel("Search By Rating Range");
		...
		add(r1).setBounds(570, 110, 50, 35);
		add(to).setBounds(635, 115, 30, 30);
		add(r2).setBounds(670, 110, 50, 35);
	...
	class Handler implements ActionListener {
		...
		public void actionPerformed(ActionEvent a) {
			...
			if (a.getSource() == SearchByYear) {
				...
				if(count < 1)
				add(new JScrollPane(textArea)).setBounds(570, 175, 430, 282);
				String out = "";
				out = FirstPage.m.SearchByRatingRange(r1.getText(), r2.getText());
